...
const HeadPhones: React.FC = () => {
  ...
  return (
    <div>
      ...
      {filtered.length > 0 && (<div className="bg-black py-8 md:py-[6.2rem] w-screen flex items-center justify-center uppercase text-[1.75rem] md:text-[2.5rem] md:font-bold leading-[0.125rem] -mt-1 mb-16">
