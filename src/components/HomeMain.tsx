function HomeMain() {
  ...
  return (
    <>
      <div className="bg-home-header-mobile bg-[center] bg-100% bg-no-repeat h-[44rem] homeImage flex justify-center items-center flex-col px-8">
          <div className=" flex items-center flex-col px-6 justify-center text-center -mb-[8rem]">
          ...
          <button className="w-[10rem] h-[3rem] bg-[#D87D4A] text-white text-[0.8125rem] mt-7">SEE PRODUCT</button>
          </div>
      </div>
    </>
  );
