      ...
      <div className='px-6 pt-4'>
        ...
        <div>
          ...
          <div className='mb-[5rem]'>
            <h2 className='text-[1.5rem] leading-[2.25rem] font-bold tracking-[0.05356rem] mb-6'>IN THE BOX</h2>
            <div>
          ...
          <div className="flex items-center flex-col justify-center">
            <picture>
              ...
              <img className='rounded-lg mb-5' width="327px" height="174px" src={singleProduct?.gallery.first.mobile} alt="" />
            </picture>
            <picture>
              ...
              <img className='rounded-lg mb-5' width="327px" height="174px" src={singleProduct?.gallery.second.mobile} alt="product" />
            </picture>
            <picture>
